...
public class CustomCowUdderModel extends ModelQuadruped {
    ...
    public CustomCowUdderModel() {
        ...
        udder.setRotationPoint(0.0F, 19.0F, -3.0F);
        body.addChild(udder);
        this.udder.setTextureOffset(52, 0).addBox(-2.0F, -17.0F, -7.0F, 4, 6, 2, 0.0F);
        this.udder.setTextureOffset(53, 1).addBox(-2.0F, -17.0F, -8.0F, 4, 6, 1, 0.0F);
