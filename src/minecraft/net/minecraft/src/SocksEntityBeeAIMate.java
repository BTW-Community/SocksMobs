...
public class SocksEntityBeeAIMate extends EntityAIBase
{
    protected SocksMobsEntityBee theAnimal;
    World theWorld;
    ...
    public SocksEntityBeeAIMate(SocksMobsEntityBee par1EntityAnimal, float par2)
    {
