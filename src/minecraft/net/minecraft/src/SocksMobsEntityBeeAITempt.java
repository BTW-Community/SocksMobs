...
public class SocksMobsEntityBeeAITempt extends EntityAIBase
{
    /** The entity using this AI that is tempted by the player. */
    private SocksMobsEntityBee temptedEntity;
    ...
    public SocksMobsEntityBeeAITempt(SocksMobsEntityBee par1EntityCreature, float par2, int par3, boolean par4)
    {
    ...
    private boolean ShouldContinueFollowing()
    {
        ...
        {
            if (this.temptedEntity.getDistanceSqToEntity(this.temptingPlayer) > 256.0D)
            {
                return false;
            }
            else
