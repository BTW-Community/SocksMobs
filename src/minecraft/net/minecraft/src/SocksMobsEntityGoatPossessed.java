...
public class SocksMobsEntityGoatPossessed extends EntityCreature implements IAnimals
{
    ...
    {
        super(var1);
        this.texture = "/socksmobs/goat_possesed.png";
        ...
        this.tasks.addTask(3, new EntityAIRunAtTarget(this, 1.6F, 1.6F));
        ...
        //this.tasks.addTask(4, new FCEntityAIWolfDireHowl(this));
        this.tasks.addTask(5, new FCEntityAIWanderSimple(this, 0.3F));
        ...
        //this.targetTasks.addTask(4, new EntityAINearestAttackableTarget(this, SocksMobsEntityGoat.class, 16.0F, 0, false));
    }
