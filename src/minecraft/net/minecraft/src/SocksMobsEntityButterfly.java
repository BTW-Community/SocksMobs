...
public class SocksMobsEntityButterfly extends EntityAmbientCreature
{
    /**
    ...
    public SocksMobsEntityButterfly(World par1World)
    {
        super(par1World);
        this.texture = "/socksmobs/butterfly.png";
