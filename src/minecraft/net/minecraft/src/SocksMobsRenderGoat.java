...
public class SocksMobsRenderGoat extends RenderLiving
{
	SocksMobsModelGoatUdderFull m_ModelUdder = new SocksMobsModelGoatUdderFull();
	
	public SocksMobsRenderGoat(ModelBase par1ModelBase, float par2)
    {
        super(par1ModelBase, par2);
        this.setRenderPassModel(this.m_ModelUdder);
    }

	public void renderGoat(SocksMobsEntityGoat par1EntityGoat, double par2, double par4, double par6, float par8, float par9)
    {
    ...
    {
        this.renderGoat((SocksMobsEntityGoat)par1EntityLiving, par2, par4, par6, par8, par9);
    }
    ...
    {
        this.renderGoat((SocksMobsEntityGoat)par1Entity, par2, par4, par6, par8, par9);
    ...
    {
        if (var2 == 0 && ((SocksMobsEntityGoat)var1).GotMilk())
        {
            return 1;
        }
        else
    ...
    public void RenderKickAttackDebug(SocksMobsEntityGoat var1, double var2, double var4, double var6, float var8, float var9)
    {
