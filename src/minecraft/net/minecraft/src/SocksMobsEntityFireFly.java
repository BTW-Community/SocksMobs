...
public class SocksMobsEntityFireFly extends EntityAmbientCreature
{
    /**
    ...
    public SocksMobsEntityFireFly(World par1World)
    {
        super(par1World);
        this.texture = "/socksmobs/firefly.png";
    ...
    {
        return FCBetterThanWolves.fcItemBatWing.itemID;
    }
